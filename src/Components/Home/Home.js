    ...
    return (
        <>
            ...
            <div className="cardList">
                ...
                <StandardCard imageLink="/assets/images/Algorithms.jpg" title="Algorithms" description="Select Algorithms, Data-Structures and Problems from the book Introduction to Algorithms" isLink="true" goTo="https://github.com/ppadam2/Algorithms" />
            </div>
            </>
            }
